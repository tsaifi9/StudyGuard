...
users = User.create([{email: 'sam@calpoly.edu',password: 'password'},{email: 'ianmitchel@calpoly.edu',password: 'password'},{email: 'talha@calpoly.edu',password: 'password'},{email: 'spencer@calpoly.edu',password: 'password'},{email: 'max@calpoly.edu',password: 'password'},{email: 'sunjay@calpoly.edu',password: 'password'},{email: 'elaine@calpoly.edu',password: 'password'}])
