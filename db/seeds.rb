...
users = User.create([
      ...
      {email: 'ianmitchel@calpoly.edu',name:'Ian',password: 'password'},
      {email: 'talha@calpoly.edu',name:'Talha',password: 'password'},
