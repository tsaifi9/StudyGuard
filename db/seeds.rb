...
groups = Group.create([{name: 'Close Friends'},{name: 'History 101'},{name: 'Biology 101'},{name: 'Sociology 101'},{name:'Psychology 101'},{name: 'CPE101'},{name: 'Operating Systems'},{name:'CPE430'},{name: 'IT'},{name:'Global Applications'}]) 
...
groups[8].users << users[0]
groups[9].users << users[0]
...
groups[8].users << users[1]
groups[9].users << users[1]
...
groups[8].users << users[2]
groups[9].users << users[2]
...
groups[8].users << users[4]
groups[9].users << users[4]
...
groups[8].users << users[5]
groups[9].users << users[5]
...
groups[8].users << users[6]
groups[9].users << users[6]
